<?php
/**
 * Alumni Community Profile Page — alumni portal.
 *   URL: alumni_community_profile.php?type=admin|alumni&id={user_id}
 */
...
if ($profileId <= 0) {
    $profileType = 'alumni';
    $profileId   = (int) $viewer['alumni_id'];
}
if ($profileId <= 0) {
...
if (!$userRow) {
    ...
    echo '<!DOCTYPE html><html><body style="font-family:sans-serif;padding:40px"><h2>Profile not found</h2><a href="alumni_community.php">← Back to Community</a></body></html>';
    exit;
}
...
$isOwnProfile = ($profileType === 'alumni' && (int) $viewer['alumni_id'] === (int) $userRow['id']);
...
/* Big avatar helper */
function alumni_profile_big_avatar(?string $photoPath, string $name, string $size = '96px'): string
{
...
<head>
    ...
    <title><?php echo community_h($displayName); ?> – Community – Alumni Portal</title>
...
<div class="layout">
    ...
    <main class="main-content animate-fadeIn">
            ...
            <div class="prof-card">
                ...
                <div class="prof-header">
                    <div class="prof-photo-wrap" id="profPhotoWrap">
                        <?php echo alumni_profile_big_avatar($displayPhoto, (string)$displayName, '96px'); ?>
                        <?php if ($isOwnProfile): ?>
                ...
                <form id="profEditForm" enctype="multipart/form-data">
                    ...
                    <div class="prof-preview-wrap">
                        <div id="profModalAvatarWrap">
                            <?php echo alumni_profile_big_avatar($displayPhoto, (string)$displayName, '72px'); ?>
                        </div>
                        <div>
        ...
        (function () {
            ...
            // Auto-open the edit modal when arriving with #edit in the URL (e.g. from alumni_profile.php)
