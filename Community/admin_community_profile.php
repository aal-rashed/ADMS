<?php
/**
 * Admin Community Profile Page — admin portal.
 *   URL: admin_community_profile.php?type=admin|alumni&id={user_id}
 */
session_start();
...
if (!$userRow) {
    ...
    echo '<!DOCTYPE html><html><body style="font-family:sans-serif;padding:40px"><h2>Profile not found</h2><a href="admin_community.php">← Back to Community</a></body></html>';
    exit;
}
...
$isOwnProfile = ($profileType === 'admin' && (int) $viewer['admin_id'] === (int) $userRow['id']);
...
/* Big avatar helper */
function admin_profile_big_avatar(?string $photoPath, string $name, string $size = '96px'): string
{
...
<head>
    ...
    <title><?php echo community_h($displayName); ?> – Community – ADMS Admin</title>
            ...
            <div class="prof-card">
                ...
                <div class="prof-header">
                    <div class="prof-photo-wrap" id="profPhotoWrap">
                        <?php echo admin_profile_big_avatar($displayPhoto, (string)$displayName, '96px'); ?>
                        <?php if ($isOwnProfile): ?>
                ...
                <form id="profEditForm" enctype="multipart/form-data">
                    ...
                    <div class="prof-preview-wrap">
                        <div id="profModalAvatarWrap">
                            <?php echo admin_profile_big_avatar($displayPhoto, (string)$displayName, '72px'); ?>
                        </div>
                        <div>
